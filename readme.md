<div align="center">
    ...
    <i>A list with a bunch of Fabric (and/or quilt) client side mods for minecraft</i>
</div>
...
| Mod                | Description                                                                                                          | Download                                                               |
| ------------------ | -------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------- |
| Advancement Info   | Enlarges the advancement menu, and helps keep track of what needs to be done to complete advancements                | [Modrinth](https://modrinth.com/mod/advancementinfo/versions)          |
...
| BetterF3              | Improves and allows the customisation of the F3 menu.                                                                     | [Github](https://modrinth.com/mod/betterf3/versions)                     |
| BetterPingDisplay     | Displays each player's ping in the tab menu. Does not work properly on some servers such as MCC-Island.                   | [Modrinth](https://modrinth.com/mod/better-ping-display-fabric/versions) |
...
| Numeral Ping          | Displays each player's ping in the tab menu, and replaces the connection bars. Does not work properly on some servers.    | [Modrinth](https://modrinth.com/mod/numeral-ping/versions)               |
...
| Ugly Scoreboard Fix   | Removes scoreboard numbers and offers multiple scoreboard modifications to optimize the look of the sidebar in your game. | [Modrinth](https://modrinth.com/mod/ugly-scoreboard-fix/versions)        |
| Visible Toggle Sprint | Shows your sprinting (or sneaking) state. Highly configurable.                                                            | [Modrinth](https://modrinth.com/mod/visible-toggle-sprint/versions)      |
| WTHIT                 | What the hell is that?                                                                                                    | [Modrinth](https://modrinth.com/mod/wthit/versions)                      |
