...
| Ugly Scoreboard Fix | Offers multiple scoreboard modifications to optimize the look of the sidebar in your game. (Removes numbers)            | [Modrinth](hhttps://modrinth.com/mod/ugly-scoreboard-fix/versions)     |
